        ...
        <div style={{backgroundColor: '#000000', color: '#fff'}}>
         ...
         <div className='row'>
             <div className="col-sm-4" style={{marginBottom: 10 }}>
                 <img src="https://media.istockphoto.com/photos/blue-bonnet-big-rig-semi-truck-with-black-grille-transporting-cargo-picture-id1320745755?b=1&k=20&m=1320745755&s=170667a&w=0&h=iCUX581EcfkWHw4pO1OgsHOL9IaU5fCARowhBloG_Qo=" style={{width: '100%', height: 250}} />
